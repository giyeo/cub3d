...
void	read_file_test_check_several_blines()
{
	...
	TEST_ASSERT_EQUAL_STRING("NO ../textures/texture1", file_read[1]);
	TEST_ASSERT_EQUAL_STRING("\0", file_read[2]);
	TEST_ASSERT_EQUAL_STRING("SO ../textures/texture2", file_read[3]);
	TEST_ASSERT_EQUAL_STRING("\0", file_read[4]);
	TEST_ASSERT_EQUAL_STRING("WE ../textures/texture3", file_read[5]);
	TEST_ASSERT_EQUAL_STRING("\0", file_read[6]);
	TEST_ASSERT_EQUAL_STRING("EA ../textures/texture4", file_read[7]);
